...
<%@ include file ="../include/header.jsp" %>
	<div class="bar">
        <div class="bar_logo">
            ...
            <a href="${path}/member/admin.do">Jewelry</a>
        </div>
        
        <div class="bar_menu">
            <li><a href="${path}/member/info.do">Info</a></li>
            <li><a href="${path}/member/list.do">memberList</a></li>
            <li><a href="${path}/product/allList.do">product</a></li>
            <li><a href="${path}/product/write.do">register</a></li>
            <li><a href="${path}/board/list.do">Board</a></li>
            <li><a href="${path}/order/adminList.do">orderList</a></li>
        ...
        <ul class="bar_icons">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <li><a href="${path}/member/logout.do"><i class="fas fa-user-lock"></i></a></li>
                </c:otherwise>
            </c:choose>
        </ul>
